...
namespace Think\Blade\Compilers;

use InvalidArgumentException;
use Think\Blade\Support\Blade;
use Think\Blade\Compilers\CompilerInterface;
use Think\Blade\Factory;
use Think\Blade\Support\Arr;
use Think\Blade\Support\Collection;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     *
     * @param  string  $contents
     * @return \Think\Blade\Support\Collection
     */
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php if (\Think\Blade\Support\Blade::check('{$name}', {$expression})): ?>"
                : "<?php if (\Think\Blade\Support\Blade::check('{$name}')): ?>";
        });
        ...
        $this->directive('else' . $name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php elseif (\Think\Blade\Support\Blade::check('{$name}', {$expression})): ?>"
                : "<?php elseif (\Think\Blade\Support\Blade::check('{$name}')): ?>";
        });
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \Think\Blade\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
