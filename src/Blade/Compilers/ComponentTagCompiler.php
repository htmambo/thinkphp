...
use Think\Blade\AnonymousComponent;
...
class ComponentTagCompiler
{
	...
	$fo = new \Think\Blade\Filesystem\Filesystem();
        $this->blade = $blade ?: new BladeCompiler($fo, sys_get_temp_dir());
    }
...
<?php $attributes = $attributes->except(new Collection($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['.$this->attributesToString($attributes->all(), $escapeAttributes = $class !== DynamicComponent::class).']); ?>';
    ...
    public function componentClass(string $component)
    {
        ...
        $guess = new Collection($this->blade->getAnonymousComponentNamespaces())
        ...
        return preg_replace_callback(
            '/@(class)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'class') {
                    ...
                    return ":class=\"\Think\Blade\Support\Arr::toCssClasses{$match[2]}\"";
                }
        ...
        return preg_replace_callback(
            '/@(style)(\( ( (?>[^()]+) | (?2) )* \))/x', function ($match) {
                if ($match[1] === 'style') {
                    ...
                    return ":style=\"\Think\Blade\Support\Arr::toCssStyles{$match[2]}\"";
                }
