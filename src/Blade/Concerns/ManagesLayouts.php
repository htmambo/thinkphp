<?php
namespace Think\Blade\Concerns;

use InvalidArgumentException;
use Think\Blade\Contracts\View\View;
...
trait ManagesLayouts
{
    ...
    public function startSection($section, $content = null)
    {
        if ($content === null) {
            ...
            $this->extendSection($section, $content instanceof View ? $content : be($content));
        }
    }
    ...
    {
        $sectionContent = $default instanceof View ? $default : be($default);
