...
return array(
    ...
    'CONTROLLER_SUFFIX'      => 'Controller', //控制器类名后缀
    ...
    'TMPL_ACTION_ERROR'      => CORE_PATH . 'Helper/Tpl/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS'    => CORE_PATH . 'Helper/Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE'    => CORE_PATH . 'Helper/Tpl/think_exception.tpl', // 异常页面的模板文件
