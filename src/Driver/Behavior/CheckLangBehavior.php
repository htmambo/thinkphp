 ...
 * 语言检测 并自动加载语言包
 */
class CheckLangBehavior extends \Think\Behavior
{
    ...
    private function checkLanguage()
    {
        ...
        // 定义当前语言
        $langSet = C('LANG_SET', strtolower($langSet));

        // 读取框架语言包
        $file = CORE_PATH . 'Lang/' . $langSet . '.php';
        if ($langSet != C('DEFAULT_LANG') && is_file($file)) {
            L(include $file);
        }
